...
export async function makeDropdown(callElem) {
  ...
  let existingContainer = document.body.querySelector(`.dropdown-root[dropdown-id="${id}"]`)
  ...
  dropdownContainer.setAttribute('target-parent', `body child #${id}`)
  ...
  setTimeout(()=>document.body.appendChild(dropdownContainer))
}